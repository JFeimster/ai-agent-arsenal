---
title: "Ecommerce Scenario Planning Prompt Pack"
asset_type: "prompt-pack"
source_repo: "JFeimster/ecommerce-cash-flow"
source_path: "prompts/scenario-planning-prompts.md"
audience: "ecommerce operators and advisors stress-testing 90-day cash outcomes"
...
tags:
  ...
  - forecasting
---
# Ecommerce Scenario Planning Prompt Pack
...
Use this pack to stress-test Conservative, Base, and Optimistic cash outcomes before making inventory, ad spend, hiring, or financing decisions. Keep assumptions explicit and keep output ranges realistic.
...
### Debt, Revenue, and Growth Stress Tests
...
### Decision and Founder Summary Outputs
...
- Do not frame scenario results as approvals, qualifications, eligibility, or guarantees.
- Treat scenario outputs as planning support, not legal, tax, accounting, lending, investment, or financial advice.
